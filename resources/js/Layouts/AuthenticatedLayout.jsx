            ...
            <nav className="bg-white border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink href={route('kelass')} active={route().current('kelass')}>
                                    Kelas
                                </NavLink>
                                ...
                                <NavLink href={route('mentors')} active={route().current('mentors')}>
                                    Mentor
                                </NavLink>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('kelass')} active={route().current('kelass')}>
                            Kelas
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink href={route('alumni')} active={route().current('alumni')}>
                            Alumni
                        </ResponsiveNavLink>
                        <ResponsiveNavLink href={route('mentors')} active={route().current('mentors')}>
                            Mentor
                        </ResponsiveNavLink>
